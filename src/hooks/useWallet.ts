...
//       } else {
//         // XUMM이 없는 경우 에러 처리 또는 다른 로직 추가
//         throw new Error('XUMM 지갑을 찾을 수 없습니다.');
//       }
...
//             balance: {
//               xrp: '0',
//               ksc: data.data?.formattedBalance || '0'
//             }
//           }));
//         } else {
//           throw new Error(data.message || '잔액 조회에 실패했습니다.');
...
//   // KSC 전송
//   const sendKSC = useCallback(async (to: string, amount: string, chain: 'xrpl' | 'avalanche') => {
//     setIsLoading(true);
//     setError(null);
...
//         const contractAddress = process.env.NEXT_PUBLIC_KSC_CONTRACT_ADDRESS || '0x0000000000000000000000000000000000000000';
