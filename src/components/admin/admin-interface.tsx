    ...
    <div className="max-w-5xl mx-auto p-6">
        ...
        {contractInfo ? (
          <div className="grid md:grid-cols-3 gap-4">
            <div className="bg-ksc-mint/20 rounded-lg p-4 border border-ksc-mint/30">
              ...
              <div className="text-sm text-ksc-gray">{t('admin.contractInfo.totalSupply')}</div>
            </div>
            ...
            <div className="bg-ksc-mint/20 rounded-lg p-4 border border-ksc-mint/30">
              ...
              <div className="text-sm text-ksc-gray">{t('admin.contractInfo.totalMinted')}</div>
            </div>
            ...
            <div className="bg-ksc-mint/20 rounded-lg p-4 border border-ksc-mint/30">
              ...
              <div className="text-sm text-ksc-gray">{t('admin.contractInfo.totalBurned')}</div>
            </div>
          </div>
        ) : (
      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <div className="card p-6">
          <h3 className="text-lg font-semibold text-ksc-white mb-4">{t('admin.mint.title')}</h3>
        ...
        {/* 소각 기능 */}
        <div className="card p-6">
          <h3 className="text-lg font-semibold text-ksc-white mb-4">{t('admin.burn.title')}</h3>
      ...
      <div className="card p-6 mt-6">
        <h3 className="text-lg font-semibold text-ksc-white mb-4">{t('admin.emergency.title')}</h3>
