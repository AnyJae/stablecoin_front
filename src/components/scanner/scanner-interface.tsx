...
import { Search, Filter, ExternalLink, Copy, RefreshCw, TrendingUp, TrendingDown } from 'lucide-react';
        ...
        {networkStats.map((stat) => (
          <div key={stat.network} className="card bg-ksc-card border-ksc-border">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-xl font-semibold text-ksc-white">
                {stat.network} 네트워크
              </h3>
                ...
                <tr key={tx.id} className="hover:bg-ksc-box/30 transition-colors">
                  <td className="px-6 py-4">
                    <div className="flex items-center space-x-2">
                      <span className="text-ksc-white font-mono text-sm">
                        {formatHash(tx.hash)}
                      </span>
                      <button
                      ...
                      {copiedHash === tx.hash && (
                        <span className="text-ksc-mint text-xs">복사됨!</span>
                      )}
                    </div>
                  </td>
                  <td className="px-6 py-4">
