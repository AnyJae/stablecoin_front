        ...
        <div className="text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="card-hover text-center">
              ...
              <h3 className="text-lg font-semibold text-ksc-white mb-2">{t('home.features.items.secure.title')}</h3>
            ...
            <div className="card-hover text-center">
              ...
              <h3 className="text-lg font-semibold text-ksc-white mb-2">{t('home.features.items.realtime.title')}</h3>
              <p className="text-ksc-gray">
            ...
            <div className="card-hover text-center">
              ...
              <h3 className="text-lg font-semibold text-ksc-white mb-2">{t('home.features.items.crosschain.title')}</h3>
              <p className="text-ksc-gray">
          ...
          <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto">
            <div className="text-center">
              ...
              <div className="text-sm text-ksc-gray">{t('home.stats.kscValue')}</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-ksc-mint mb-2">100%</div>
              <div className="text-sm text-ksc-gray">{t('home.stats.krwPeg')}</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-ksc-mint mb-2">2</div>
              <div className="text-sm text-ksc-gray">{t('home.stats.networks')}</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-ksc-mint mb-2">24/7</div>
              <div className="text-sm text-ksc-gray">{t('home.stats.trading')}</div>
            </div>
          </div>
        </div>
      </div>
