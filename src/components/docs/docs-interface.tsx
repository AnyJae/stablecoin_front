      ...
      content: (
        <div className="space-y-4">
          ...
          <p className="text-ksc-gray">
            KSC(Korea Stable Coin)는 한국 원화와 1:1 연동되는
            스테이블코인입니다. XRPL과 Avalanche 블록체인을 기반으로 하여
            안정성과 확장성을 모두 확보했습니다.
          </p>

          <h4 className="text-md font-semibold text-ksc-white mt-6">
            주요 특징
          </h4>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-4">
            <div className="border border-ksc-border rounded-lg p-4 bg-ksc-box/30">
              <h4 className="font-semibold text-ksc-white mb-2">
                Avalanche API
              </h4>
              <div className="text-sm space-y-2">
                <div>
                  <code className="bg-ksc-box px-2 py-1 rounded text-ksc-mint">
                    GET /api/avalanche/balance/:address
                  </code>{" "}
                  - KSC 잔액 조회
                </div>
                <div>
                  <code className="bg-ksc-box px-2 py-1 rounded text-ksc-mint">
                    GET /api/avalanche/contract-info
                  </code>{" "}
                  - 컨트랙트 정보
                </div>
                <div>
                  <code className="bg-ksc-box px-2 py-1 rounded text-ksc-mint">
                    POST /api/avalanche/transfer
                  </code>{" "}
                  - KSC 전송
                </div>
                <div>
                  <code className="bg-ksc-box px-2 py-1 rounded text-ksc-mint">
                    GET /api/avalanche/transaction/:hash
                  </code>{" "}
                  - 트랜잭션 조회
                </div>
              </div>
        ...
        <div className="space-y-4">
          ...
          <div className="bg-ksc-box/50 rounded-lg p-4 border border-ksc-border">
            ...
            <div className="text-sm text-ksc-gray space-y-2">
              <div>
                <strong>Node.js:</strong> 18+ 버전
              </div>
              <div>
                <strong>npm:</strong> 8+ 버전
              </div>
              <div>
                <strong>MetaMask:</strong> 브라우저 확장
              </div>
              <div>
                <strong>Hardhat:</strong> 스마트 컨트랙트 개발
              </div>
            </div>
          </div>
